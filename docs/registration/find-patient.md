...
![Find Patient with the results of a search](../assets/screens/registration/find-patient.png)
...
1. In <span class="n">1</span> **Mobile No., Name, C.R. No. or I.P. No.**, type any of these:
    ...
    - a C.R. No., e.g. `84839/26` (or just `84839`);
...
![All the patients registered with one mobile number](../assets/screens/registration/find-patient-mobile.png)
...
![Quick registration of a new patient](../assets/screens/registration/find-patient-quick.png)
